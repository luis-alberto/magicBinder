/**************************************************************************
 * MagicBinderApplicationBase.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
 ...
 * Harmony.
 * You should edit MagicBinderApplication class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class MagicBinderApplicationBase
    extends Application {

    /** TAG for debug purpose. */
    protected static final String TAG = "MagicBinderApplication";
    /** Singleton. */
    private static volatile MagicBinderApplicationBase singleton;
    /** Date format. */
     ...
     */
    private static void setSingleton(MagicBinderApplicationBase application) {
        if (singleton == null) {
     ...
     */
    public static MagicBinderApplicationBase getApplication() {
        return singleton;
    }
    ...
    public static String getVersion(final android.content.Context ctx) {
        final SharedPreferences settings = ctx.getSharedPreferences(
                MagicBinderApplicationBase.PREFS_PUBL,
                android.content.Context.MODE_WORLD_READABLE);

        return settings.getString(
                MagicBinderApplicationBase.PREFS_VERS, "");
    }

/**************************************************************************
 * MagicBinderProviderBase.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
...
/**
 * MagicBinderProviderBase.
 */
public class MagicBinderProviderBase extends ContentProvider {
    /** TAG for debug purpose. */
    protected static String TAG = "MagicBinderProvider";
    /** Uri not supported. */
    protected static String URI_NOT_SUPPORTED;

    /* Tools / Common. */
    /** com.magicbinder.provider authority. */
    ...
    public boolean onCreate() {
        ...
        BinderProviderAdapter binderProviderAdapter =
            new BinderProviderAdapter(this);
        this.db = binderProviderAdapter.getDb();            
        this.providerAdapters.add(binderProviderAdapter);
        this.providerAdapters.add(
                new QualityProviderAdapter(this));
        this.providerAdapters.add(
                new ColortoCardProviderAdapter(this));
        this.providerAdapters.add(
                new ColorProviderAdapter(this));
        this.providerAdapters.add(
                new Binder_CardProviderAdapter(this));
        this.providerAdapters.add(
                new CardProviderAdapter(this));

/**************************************************************************
 * MagicBinderMenuBase.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.magicbinder.menu.base;
...
import com.magicbinder.menu.CrudCreateMenuWrapper;
import com.magicbinder.menu.CrudDeleteMenuWrapper;
import com.magicbinder.menu.CrudEditMenuWrapper;
import com.magicbinder.menu.SaveMenuWrapper;

/**
 * MagicBinderMenuBase.
 * This class is regenerated with harmony.
 * To modify or learn more about this class,
 * please see MagicBinderMenu.
 */
public abstract class MagicBinderMenuBase {
    /** Crudcreate value. */
     ...
     */
    protected MagicBinderMenuBase(final android.content.Context ctx)
                                                        throws Exception {
        this(ctx, null);
    }

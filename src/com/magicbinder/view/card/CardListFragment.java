/**************************************************************************
 * CardListFragment.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
...
/** Card list fragment.
 *
 * This fragment gives you an interface to list all your Cards.
 *
 * @see android.app.Fragment
 */
public class CardListFragment
        extends HarmonyListFragment<Card>
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_card_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.cardProgressLayout,
                R.id.cardListContainer);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new CardListLoader(this.getActivity(),
    ...
    public void onLoadFinished(
        ...
        ArrayList<Card> users = CardContract.cursorToItems(data);
        this.mAdapter.setNotifyOnChange(false);
        this.mAdapter.setData(
                new CardListAdapter
                    .CardSectionIndexer(users));

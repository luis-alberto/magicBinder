/**************************************************************************
 * SQLiteAdapterBase.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
...
public abstract class SQLiteAdapterBase<T> {
    ...
    public static final String TAG = "MagicBinderSQLiteAdapterBase";
     ...
     * Open Helper.
     */
    protected MagicBinderSQLiteOpenHelper mBaseHelper;
    ...
    protected SQLiteAdapterBase(final android.content.Context ctx) {
        this.ctx = ctx;
        this.mBaseHelper = new MagicBinderSQLiteOpenHelper(
                ctx,
                DB_NAME,
                null,
                MagicBinderApplication.getVersionCode(ctx));

/**************************************************************************
 * ColorTestDBBase.java, MagicBinder Android
 *
 * Copyright 2015
 * Description : 
 * Author(s)   : Harmony
 ...
 */
public abstract class ColorTestDBBase extends TestDBBase {
    ...
    public void testCreate() {
        ...
        if (this.entity != null) {
            ...
            result = (int)this.adapter.insert(color);
    ...
    public void testUpdate() {
        ...
        if (this.entity != null) {
            ...
            result = (int) this.adapter.update(color);
